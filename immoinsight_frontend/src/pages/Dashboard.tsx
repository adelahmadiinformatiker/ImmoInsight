...
import { initLineChart } from '../scripts/charts/lineChart'
import { initBarChart } from '../scripts/charts/barChart'
...
const Dashboard: React.FC = () => {
  useEffect(() => {
    initLineChart('chartjs-dashboard-line')
    initBarChart('chartjs-dashboard-bar')
    initPieChart('chartjs-dashboard-pie')
    initCalendar('datetimepicker-dashboard')

    // Initialize world map with a small delay to ensure DOM is ready
    const timeout = setTimeout(() => {
      initWorldMap('#world_map')
    }, 100)
